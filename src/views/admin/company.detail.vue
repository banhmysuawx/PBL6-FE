              ...
              <div class="company-detail-wrapper">
                <div class="company-detail-box">
                  <div class="company-description">
                    <h2>Overview about {{ company_detail.company_name }}</h2>
                      ...
                      <div class="write-review">
                        ...
                        <a-form class="form-write-review">
                          ...
                          <a-form-item name="email">
                            ...
                            />
                            <a-button class="send-icon" @click="createComment">
...
export default defineComponent({
  ...
  setup() {
    const store = useMenu();
    store.onSelectedKeys(["company-management"]);
    store.onOpenKeys(["company-management"]);
  },
  components: {
    Header,
    Footer,
