          ...
          <el-container>
            ...
            <el-main>
              <div>
                ...
                <el-row style="margin:5px 10px; font-size:15px" >{{job_current.number_applicants}} Candidates</el-row>
              </div>
  ...
  export default {
      ...
      methods:{
        ...
        async searchApplicant(){
          ...
          this.job_current['number_applicants'] = this.applicants_search.length 
        },
