  ...
  <div>
    ...
    <el-container>
      ...
      <el-aside style="width: 300px">
        ...
        <div class="item-location" v-for="item in list_location" :key="item">
          <el-icon color="red"><location /></el-icon>
          <span @click="ChoiceLocation(item)"> {{item.location_name}}</span>
          <el-button link
      ...
      <el-main>
        ...
        <el-form v-if="(is_create==true)">
          ...
          <el-col style="text-align: right; width: 750px"
            ><el-button type="primary" @click="SaveLocation()">Save</el-button></el-col
          >
        </el-form>
